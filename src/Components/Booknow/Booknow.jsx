      ...
      >
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <Grid container spacing={2} ml={{ lg: 15, md: 10, sm: 7,xs:1 }}>
            {/* Row 1 */}
            <Grid size={{xs:12,sm:6,lg:5}}  data-aos="fade-up" width={{ lg: 210, sm: 200,xs:300 }}>
              <TextField
                fullWidth
                name="firstName"
                label="First Name"
            ...
            <Grid size={{xs:12,sm:6,lg:5}}  data-aos="fade-up" width={{ lg: 210, sm: 200 }}>
              <TextField
                fullWidth
                name="lastName"
                label="Last Name"
            ...
            {/* Row 2 */}
            <Grid size={{xs:12,sm:6,lg:6}}  data-aos="fade-up" width={{ lg: 210, sm: 200 }}>
              <TextField
                fullWidth
                name="email"
                label="Your Email"
            ...
            <Grid size={{xs:12,sm:6,lg:6}}  data-aos="fade-up" width={{ lg: 210, sm: 200,xs: 300}}>
              <TextField
                select
            ...
            {/* Row 4 */}
            <Grid size={{xs:12,lg:12}}  data-aos="fade-up" width={{ lg: 440, xs: 300, sm: 420, md: 630 }}>

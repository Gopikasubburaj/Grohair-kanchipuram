...
const ServicesSection = () => {
  ...
  return (
    <Box sx={{ py: 10, px: { xs: 2, sm: 4, md: 6, xl: 12 }, textAlign: "center" }}>
      ...
      >
        Unlock expert care in hair restoration and skincare at GroHair & GloSkin kanchipuram. From cutting-edge hair loss treatments to rejuvenating skin therapies, we deliver results-focused solutions that enhance beauty, restore confidence, and support long-term wellness.
      </Typography>
